        ...
        <div className="space-y-6 rounded-lg bg-white/10 p-6 shadow-xl backdrop-blur-md md:p-8">
          ...
          <TermsSection title="2. Uso de Licença">
            <p>
              ...
              materiais (informações ou software) no site Puxa time, apenas para
            ...
            <ul className="mt-2 list-disc space-y-2 pl-6">
              ...
              <li>
                ...
                software contido no site Puxa time;
              </li>
              <li>
            ...
            <p className="mt-2">
              ...
              dessas restrições e poderá ser rescindida por Puxa time a qualquer
          ...
          <TermsSection title="3. Isenção de responsabilidade">
            <ol className="list-decimal space-y-2 pl-6">
              <li>
                Os materiais no site da Puxa time são fornecidos 'como estão'.
                Puxa time não oferece garantias, expressas ou implícitas, e, por
              ...
              <li>
                Além disso, o Puxa time não garante ou faz qualquer
          ...
          <TermsSection title="4. Limitações">
            <p>
              Em nenhum caso o Puxa time ou seus fornecedores serão responsáveis
              ​​por quaisquer danos (incluindo, sem limitação, danos por perda
              de dados ou lucro ou devido a interrupção dos negócios)
              decorrentes do uso ou da incapacidade de usar os materiais em Puxa
              time, mesmo que Puxa time ou um representante autorizado da Puxa
              time tenha sido notificado oralmente ou por escrito da
          ...
          <TermsSection title="5. Precisão dos materiais">
            <p>
              Os materiais exibidos no site da Puxa time podem incluir erros
              técnicos, tipográficos ou fotográficos. Puxa time não garante que
              qualquer material em seu site seja preciso, completo ou atual.
              Puxa time pode fazer alterações nos materiais contidos em seu site
              a qualquer momento, sem aviso prévio. No entanto, Puxa time não se
          ...
          <TermsSection title="6. Links">
            <p>
              O Puxa time não analisou todos os sites vinculados ao seu site e
              não é responsável pelo conteúdo de nenhum site vinculado. A
              inclusão de qualquer link não implica endosso por Puxa time do
          ...
          <TermsSection title="Modificações">
            <p>
              O Puxa time pode revisar estes termos de serviço do site a
          ...
          <TermsSection title="Lei aplicável">
            <p>
              ...
              as leis do Puxa time e você se submete irrevogavelmente à
